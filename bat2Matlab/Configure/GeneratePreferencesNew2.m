function prefs = GeneratePreferencesNew2(base_batlab_filename)
%
...
%     if ~exist(base_batlab_data_path, 'dir')
%         disp('invalid base data path')
%         prefs = [];
%         return
%     end
    [parentDir base_filename]=fileparts(base_batlab_filename);
...
%     end
    ...
    prefs.Bat2Matlab_data_filepath = [parentDir 'Extracted Data' filesep tok '.mat'];
    prefs.raw_data_filepath = [parentDir tok '.raw'];
    prefs.xml_data_filepath = [parentDir tok '-alltests-nospikes.xml'];
    prefs.pst_data_filepath = [parentDir tok '.pst'];
