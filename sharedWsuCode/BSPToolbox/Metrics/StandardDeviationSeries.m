function [varargout] = StandardDeviationSeries(varargin)
%StandardDeviationSeries: Standard deviations of successive intervals.
%
%   [y] = StandardDeviationSeries(x,fs,wl,pf);
%
%   x    Input Signal.
...
%
%   The StandardDevationSeries function calculate the standard deviations of
%   succesive intervals of a time-series and returns a vector of 
%   these standard deviation values. Convolution with the fast Fourier 
%   transform is used to speed the calculation
%
%   Example: Calculate the standard deviations of 2500 sample windows 
%   of a electrocardiogram signal, and plot result.
%
%      load ECG;
%      StandardDeviationSeries(ecg,fs,2500,1);
%
%   References
%
...
%=====================================================================
    ...
    y =  sqrt((xSquaredBar(wl:(lenX))-xBarSquared(wl:(lenX)))*(wl/(wl-1)));
...
%=====================================================================
    ...
    if pf
        ...
        titstr = sprintf('Standard Deviations of Intervals of length %3.3f s',wl/fs);
        set(titH,'String',titstr);
        set(ylabH,'String','Standard Deviation');
