...
%   Physiological Society, vol 94 ppH1643-H1656, 1994.
%
%   Version 2.20.21 DT
%
...
%=====================================================================
    ...
    if length(N)~=1
        ...
        error('Error: N must be scalar.');
        return
        
    elseif isa(N,'numeric') ~= 1
            
        error('Error: N must be numeric');
        return
    ...
    elseif length(off)~=1
        ...
        error('Error: off must be scalar.');
        return
    
    elseif isa(off,'numeric') ~= 1
            
        error('Error: off must be numeric');
        return
        
        
    elseif off<1
        
        error('Error: off must be positive.');
        return
        
    elseif floor(off) ~= off
        
        error('Error: off must be an integer.');
        return
