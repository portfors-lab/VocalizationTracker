function [mean_correlation ...
          ...
          correlations ...
          spike_rates1 ...
          spike_rates2 ] = CalculateSpikeCorr2(experiment_data, ...
                                              prefs, ...
                                              test_num1, ...
                                              trace_num1, ...
                                              test_num2, ...
...
for sweep_num1 = sweep_num1_range
    ...
    for sweep_num2 = sweep_num2_range
        ...
        if (test_num1 == test_num2 && trace_num1 == trace_num2 && sweep_num1 == sweep_num2)
            % Correlation between same signals, so skip computation and set
            % to 1
...
if length(correlations) == 0
    ...
    %otherMethod = sum(correlations)*(1/num_sweeps1^2);
